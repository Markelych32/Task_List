...
import ru.solonchev.tasklist.domain.exception.AccessDeniedException;
...
import ru.solonchev.tasklist.service.properties.JwtProperties;
...
public class JwtTokenProvider {
    ...
    public JwtResponse refreshUserTokens(
        ...
        jwtResponse.setAccessToken(
                generateAccessToken(userId, user.getUsername(), user.getRoles())
        );
